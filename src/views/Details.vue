...
<!-- 商品详情窗口 -->
					<div class="d2_right">
                        <div class="right_d1">
                            <div class="pic" :style="prop_place.pic"><img :src="det.pic_way" :style="prop_place.img" alt=""></div>
                            <div class="msg">
...
export default {
    ...
    data(){return{
        ...
        prop_place:{pic:{lineHeight:"40rem"},img:{width:"10rem"}},
    ...
    methods:{
        ...
        getdetail(pid){
            axios.get(baseURL+"/lol/details"+pid)
            .then(result=>{
                this.det=result.data[0];
                if(this.det.prop_place=="center"){
                    this.prop_place={pic:{lineHeight:"40rem"},img:{width:"10rem"}}
                }else if(this.det.prop_place=="hot"||this.det.prop_place=="like"){
                    this.prop_place={pic:{lineHeight:"23rem"},img:{width:"13rem"}}
                }
            });
        }
	},
...
.home>.d2>.d2_right>.right_d1{width: 55.5rem;height: 22.5rem;margin-left: 3.625rem;display: flex;}
.home>.d2>.d2_right>.right_d1>.pic{width: 16.25rem;height: 100%;text-align: center;}
